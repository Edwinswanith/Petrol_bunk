...
const items = [
  ...
  { href: "/settings", title: "Outlet settings", description: "Business day, prices, thresholds and owner account.", icon: Settings },
...
export default async function MorePage() {
  ...
  const alerts = buildDashboardViewModel({ shifts, expenses }).alerts;
