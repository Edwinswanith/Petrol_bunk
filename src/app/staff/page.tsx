...
export default async function StaffPage() {
  ...
  const [shifts, staff, attendance, allAttendance, payroll] = await Promise.all([
    getOperationsRepository().listShifts(), getStaffStore().listStaff(), getStaffStore().listAttendance(today), getStaffStore().listAttendance(), getStaffStore().listPayroll()
  ]);
  ...
  return <main className="page">
    ...
    <div className="reveal reveal-2"><StaffRegister staff={staff} attendance={attendance} payroll={payroll} date={today} month={month} /></div>
